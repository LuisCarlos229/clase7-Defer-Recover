...
func main() {
	/*.
	Ej 1- datos de cliente

	Un estudio contable necesita acceder a los datos de sus empleados para poder realizar
	distintas liquidaciones. Para ello, cuentan con todo el detalle necesario en un
	archivo .txt.
	...
	(Investiguen el funcionamiento del pkg “os”)
	...
	mensaje “el archivo indicado no fue encontrado o está dañado”. Sin perjuicio de ello, deberá
	siempre imprimirse por consola “ejecución finalizada”
	*/
	...
	if err != nil {
		log.Printf("el archivo indicado no fue encontrado o está dañado")
	}
